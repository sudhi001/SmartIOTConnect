...
class _SetPropertyWidgetState extends State<SetPropertyWidget> {
  ...
  final TextEditingController _sprayModuleActivate =
      TextEditingController(text: '27');
  final TextEditingController _waterModuleActivate =
                        ...
                        try {
                          if (_formKey.currentState?.validate() ?? false) {
                            ...
                            final sprayModuleActivateValue =
                                _sprayModuleActivate.value.text;
                            final waterModuleActivateValue =
                                _waterModuleActivate.value.text;
                            await bleCtr.send(
